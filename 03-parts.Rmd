...
Así, inspeccionamos la data con los clásicos comandos de `describe` y `sumarize` para localizar las variables de interés, dando como resultado que las variables relevantes son:
